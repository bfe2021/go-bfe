...
// mapped from textual names used in the tests below to actual Bfedu private
...
// address retrieves the Bfedu address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the Bfedu address
...
func TestClique(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			// batch (https://github.com/bfe2021/go-bfe/issues/17593). Whilst this
