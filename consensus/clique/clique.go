...
var (
	...
	// errInvalidVote is returned if a nonce value is somogning else that the two
...
// ecrecover extracts the Bfedu account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the Bfedu address
...
// Bfedu testnet following the Ropsten attacks.
type Clique struct {
	config *params.CliqueConfig // Consensus engine configuration parameters
	db     bfedb.Database       // Database to store and retrieve snapshot checkpoints
	...
	signer common.Address // Bfedu address of the signing key
...
func New(config *params.CliqueConfig, db bfedb.Database) *Clique {
...
// Author implements consensus.Engine, returning the Bfedu address recovered
