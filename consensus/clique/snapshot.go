...
func loadSnapshot(config *params.CliqueConfig, sigcache *lru.ARCCache, db bfedb.Database, hash common.Hash) (*Snapshot, error) {
...
func (s *Snapshot) store(db bfedb.Database) error {
