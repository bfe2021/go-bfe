...
type Database struct {
	diskdb bfedb.KeyValueStore // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb bfedb.KeyValueStore) *Database {
...
func NewDatabaseWithConfig(diskdb bfedb.KeyValueStore, config *Config) *Database {
...
func (db *Database) DiskDB() bfedb.KeyValueStore {
	return db.diskdb
}
...
func (db *Database) commit(hash common.Hash, batch bfedb.Batch, uncacher *cleaner, callback func(common.Hash)) error {
