...
func (db *Database) NewBatch() bfedb.Batch {
	return &batch{
		db: db.db,
		b:  new(leveldb.Batch),
	}
...
func (db *Database) NewIterator(prefix []byte, start []byte) bfedb.Iterator {
...
func (b *batch) Replay(w bfedb.KeyValueWriter) error {
	return b.b.Replay(&replayer{writer: w})
}

// replayer is a small wrapper to implement the correct replay Methods.
type replayer struct {
	writer  bfedb.KeyValueWriter
	failure error
}
