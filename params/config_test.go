...
func TestCheckCompatible(t *testing.T) {
	...
	tests := []test{
		{stored: AllBfeashProtocolChanges, new: AllBfeashProtocolChanges, head: 0, wantErr: nil},
		{stored: AllBfeashProtocolChanges, new: AllBfeashProtocolChanges, head: 100, wantErr: nil},
		{
		...
		{
			stored: AllBfeashProtocolChanges,
