...
var (
	...
	// AllBfeashProtocolChanges contains every protocol change (EIPs) introduced
	// and accepted by the Bfedu core developers into the Bfeash consensus.
	//
	// This configuration is intentionally not using keyed fields to force anyone
	// adding flags to the config to also have to set these fields.
	AllBfeashProtocolChanges = &ChainConfig{big.NewInt(1337), big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), nil, nil, new(BfeashConfig), nil}

	// AllCliqueProtocolChanges contains every protocol change (EIPs) introduced
	// and accepted by the Bfedu core developers into the Clique consensus.
	//
	// This configuration is intentionally not using keyed fields to force anyone
	// adding flags to the config to also have to set these fields.
	...
	TestChainConfig = &ChainConfig{big.NewInt(1), big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), nil, nil, new(BfeashConfig), nil}
...
type ChainConfig struct {
	...
	// EIP150 implements the Gas price changes (https://github.com/bfe2021/EIPs/issues/150)
	...
	Bfeash *BfeashConfig `json:"bfeash,omitempty"`
	Clique *CliqueConfig `json:"clique,omitempty"`
}

// BfeashConfig is the consensus engine configs for proof-of-work based sealing.
type BfeashConfig struct{}

// String implements the stringer interface, returning the consensus engine details.
func (c *BfeashConfig) String() string {
	return "bfeash"
}
...
// CheckConfigForkOrder checks that we don't "skip" any forks, gbfe isn't pluggable enough
