...
// information related to the Bfedu protocol such als blocks, transactions and logs.
...
// `bfe_getFilterChanges` polling Method that is also used for log filters.
//
// https://bfe.wiki/json-rpc/API#bfe_newpendingtransactionfilter
...
// It is part of the filter package since polling goes with bfe_getFilterChanges.
//
// https://bfe.wiki/json-rpc/API#bfe_newblockfilter
...
func (api *PublicFilterAPI) Logs(ctx context.Context, crit FilterCriteria) (*rpc.Subscription, error) {
	...
	logsSub, err := api.events.SubscribeLogs(bfedu.FilterQuery(crit), matchedLogs)
	if err != nil {
		return nil, err
	}
...
// Same as bfedu.FilterQuery but with UnmarshalJSON() Method.
type FilterCriteria bfedu.FilterQuery
...
//
// https://bfe.wiki/json-rpc/API#bfe_newfilter
func (api *PublicFilterAPI) NewFilter(crit FilterCriteria) (rpc.ID, error) {
	logs := make(chan []*types.Log)
	logsSub, err := api.events.SubscribeLogs(bfedu.FilterQuery(crit), logs)
	if err != nil {
		return "", err
	}
...
//
// https://bfe.wiki/json-rpc/API#bfe_getlogs
...
//
// https://bfe.wiki/json-rpc/API#bfe_uninstallfilter
...
//
// https://bfe.wiki/json-rpc/API#bfe_getfilterlogs
...
//
// https://bfe.wiki/json-rpc/API#bfe_getfilterchanges
