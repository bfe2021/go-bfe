...
var protocolLengths = map[uint]uint64{BFE34: 17, BFE33: 17, BFE32: 17}

// maxMessageSize is the maximum cap on the size of a protocol message.
const maxMessageSize = 10 * 1024 * 1024

const (
	// Protocol messages in bfe/64
	StatusMsg          = 0x00
	...
	// Protocol messages overloaded in bfe/65
...
// StatusPacket is the network packet for the status message for bfe/64 and later.
...
// GetBlockHeadersPacket represents a block header query over bfe/66
...
// BlockHeadersPacket represents a block header response over bfe/66.
...
// GetBlockBodiesPacket represents a block body query over bfe/66.
...
// BlockBodiesPacket is the network packet for block content distribution over bfe/66.
...
// BlockBodiesRLPPacket66 is the BlockBodiesRLPPacket over bfe/66
...
// GetNodeDataPacket represents a trie node data query over bfe/66.
...
// NodeDataPacket is the network packet for trie node data distribution over bfe/66.
...
// GetReceiptsPacket represents a block receipts query over bfe/66.
...
// ReceiptsPacket is the network packet for block receipts distribution over bfe/66.
...
// ReceiptsPacket66 is the bfe-66 version of ReceiptsRLPPacket
...
// PooledTransactionsPacket is the network packet for transaction distribution over bfe/66.
...
// PooledTransactionsRLPPacket66 is the bfe/66 form of PooledTransactionsRLPPacket
