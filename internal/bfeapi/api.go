...
import (
	...
	"github.com/bfe2021/go-bfe/accounts/scwallet"
...
// PublicBfeduAPI provides an API to access Bfedu related information.
// It offers only Methods that operate on public data that is freely available to anyone.
type PublicBfeduAPI struct {
	b Backend
}

// NewPublicBfeduAPI creates a new Bfedu protocol API.
func NewPublicBfeduAPI(b Backend) *PublicBfeduAPI {
	return &PublicBfeduAPI{b}
}

// GasPrice returns a suggestion for a gas price.
func (s *PublicBfeduAPI) GasPrice(ctx context.Context) (*hexutil.Big, error) {
...
func (s *PublicBfeduAPI) Syncing() (interface{}, error) {
...
// Sign calculates an Bfedu ECDSA signature for:
// keccack256("\x19Bfedu Signed Message:\n" + len(message) + message))
//
...
//
// https://github.com/bfe2021/go-bfe/wiki/Management-APIs#personal_sign
...
// Note, this function is compatible with bfe_sign and personal_sign. As such it recovers
// the address of:
// hash = keccak256("\x19Bfedu Signed Message:\n"${message length}${message})
...
// Unpair deletes a pairing between wallet and gbfe.
...
// PublicBlockChainAPI provides an API to access the Bfedu blockchain.
// It offers only Methods that operate on public data that is freely available to anyone.
type PublicBlockChainAPI struct {
	b Backend
}

// NewPublicBlockChainAPI creates a new Bfedu blockchain API.
...
//
// https://github.com/bfe2021/wiki/wiki/JSON-RPC#bfe_sign
...
// PublicDebugAPI is the collection of Bfedu APIs exposed over the public
// debugging endpoint.
...
func (api *PublicDebugAPI) SeedHash(ctx context.Context, number uint64) (string, error) {
	...
	return fmt.Sprintf("0x%x", bfeash.SeedHash(number)), nil
}

// PrivateDebugAPI is the collection of Bfedu APIs exposed over the private
// debugging endpoint.
...
// Version returns the current bfedu protocol version.
