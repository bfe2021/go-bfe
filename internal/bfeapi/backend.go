...
// Package bfeapi implements the general Bfedu API functions.
package bfeapi
...
type Backend interface {
	...
	ExtRPCEnabled() bool
	RPCGasCap() uint64        // global gas cap for bfe_call over rpc: DoS protection
	...
	return []rpc.API{
		{
			Namespace: "bfe",
			Version:   "1.0",
			Service:   NewPublicBfeduAPI(apiBackend),
			Public:    true,
		}, {
			Namespace: "bfe",
			Version:   "1.0",
