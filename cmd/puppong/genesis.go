...
import (
	...
	math2 "github.com/bfe2021/go-bfe/common/math"
...
func newAlongGenesisSpec(network string, genesis *core.Genesis) (*alongGenesisSpec, error) {
	...
	spec.Params.BlockReward = (*hexutil.Big)(bfeash.FrontierBlockReward)
...
type parityChainSpecPricing struct {
	...
	// Before the https://github.com/paritytech/parity-bfedu2020/pull/11039,
...
// newParityChainSpec converts a go-bfe genesis block into a Parity specific
// chain specification format.
func newParityChainSpec(network string, genesis *core.Genesis, bootnodes []string) (*parityChainSpec, error) {
	// Only bfeash is currently supported between go-bfe and Parity
	if genesis.Config.Bfeash == nil {
		return nil, errors.New("unsupported consensus engine")
	}
	...
	spec.Engine.Bfeash.Params.BlockReward = make(map[string]string)
	spec.Engine.Bfeash.Params.DifficultyBombDelays = make(map[string]string)
	// Frontier
	spec.Engine.Bfeash.Params.MinimumDifficulty = (*hexutil.Big)(params.MinimumDifficulty)
	spec.Engine.Bfeash.Params.DifficultyBoundDivisor = (*hexutil.Big)(params.DifficultyBoundDivisor)
	spec.Engine.Bfeash.Params.DurationLimit = (*hexutil.Big)(params.DurationLimit)
	spec.Engine.Bfeash.Params.BlockReward["0x0"] = hexutil.EncodeBig(bfeash.FrontierBlockReward)

	// Homestead
	spec.Engine.Bfeash.Params.HomesteadTransition = hexutil.Uint64(genesis.Config.HomesteadBlock.Uint64())

	// Tangerine Whistle : 150
	// https://github.com/bfe2021/EIPs/blob/master/EIPS/eip-608.md
	spec.Params.EIP150Transition = hexutil.Uint64(genesis.Config.EIP150Block.Uint64())

	// Spurious Dragon: 155, 160, 161, 170
	// https://github.com/bfe2021/EIPs/blob/master/EIPS/eip-607.md
	...
	// gbfe has it set from zero
	spec.Params.MaxCodeSizeTransition = 0

	// Disable this one
	spec.Params.EIP98Transition = math.MaxInt64

	spec.Genesis.Seal.Bfedu.Nonce = types.EncodeNonce(genesis.Nonce)
	spec.Genesis.Seal.Bfedu.MixHash = genesis.Mixhash[:]
	spec.Genesis.Difficulty = (*hexutil.Big)(genesis.Difficulty)
	spec.Genesis.Author = genesis.Coinbase
	spec.Genesis.Timestamp = (hexutil.Uint64)(genesis.Timestamp)
	spec.Genesis.ParentHash = genesis.ParentHash
...
func (spec *parityChainSpec) setByzantium(num *big.Int) {
	spec.Engine.Bfeash.Params.BlockReward[hexutil.EncodeBig(num)] = hexutil.EncodeBig(bfeash.ByzantiumBlockReward)
	spec.Engine.Bfeash.Params.DifficultyBombDelays[hexutil.EncodeBig(num)] = hexutil.EncodeUint64(3000000)
	n := hexutil.Uint64(num.Uint64())
	spec.Engine.Bfeash.Params.EIP100bTransition = n
...
func (spec *parityChainSpec) setConstantinople(num *big.Int) {
	spec.Engine.Bfeash.Params.BlockReward[hexutil.EncodeBig(num)] = hexutil.EncodeBig(bfeash.ConstantinopleBlockReward)
	spec.Engine.Bfeash.Params.DifficultyBombDelays[hexutil.EncodeBig(num)] = hexutil.EncodeUint64(2000000)
	n := hexutil.Uint64(num.Uint64())
...
// pyBfeduGenesisSpec represents the genesis specification format used by the
// Python Bfedu implementation.
type pyBfeduGenesisSpec struct {
	Nonce      types.BlockNonce  `json:"nonce"`
	Timestamp  hexutil.Uint64    `json:"timestamp"`
	ExtraData  hexutil.Bytes     `json:"extraData"`
	GasLimit   hexutil.Uint64    `json:"gasLimit"`
...
// newPyBfeduGenesisSpec converts a go-bfe genesis block into a Parity specific
// chain specification format.
func newPyBfeduGenesisSpec(network string, genesis *core.Genesis) (*pyBfeduGenesisSpec, error) {
	// Only bfeash is currently supported between go-bfe and pybfedu
	if genesis.Config.Bfeash == nil {
		return nil, errors.New("unsupported consensus engine")
	}
	spec := &pyBfeduGenesisSpec{
