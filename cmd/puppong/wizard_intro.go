...
// setting up a new or managing an existing Bfedu private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppong, your Bfedu private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Bfedu network down to  |")
	fmt.Println("| the genesis block, bootnodes, miners and bfestats servers |")
	...
	log.Info("Administering Bfedu network", "name", w.network)
