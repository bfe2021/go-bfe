...
var (
	walletCommand = cli.Command{
		Name:      "wallet",
		Usage:     "Manage Bfedu presale wallets",
		ArgsUsage: "",
		Category:  "ACCOUNT COMMANDS",
		Description: `
    gbfe wallet import /path/to/my/presale.wallet

will prompt for your password and imports your bfeer presale account.
		...
		Subcommands: []cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import Bfedu presale wallet",
				ArgsUsage: "<keyFile>",
				...
				Description: `
	gbfe wallet [options] /path/to/my/presale.wallet
...
between bfedu nodes by simply copying.
...
For non-interactive use the password can be specified with the --password flag:
    ...
    gbfe account update [options] <address>
...
For non-interactive use the password can be specified with the -password flag:
    ...
    gbfe account import [options] <keyfile>

Note:
As you can directly copy your encrypted accounts to another bfedu instance,
...
func accountCreate(ctx *cli.Context) error {
	cfg := gbfeConfig{Node: defaultNodeConfig()}
	// Load config file.
