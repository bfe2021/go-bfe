...
func newTester(t *testing.T, confOverride func(*bfeconfig.Config)) *tester {
	...
	// Create a networkless protocol stack and start an Bfedu service within
