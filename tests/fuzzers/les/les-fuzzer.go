...
import (
	...
	l "github.com/bfe2021/go-bfe/les"
...
var (
	...
	bankFunds  = new(big.Int).Mul(big.NewInt(100), big.NewInt(params.Bfeer))
...
func makechain() (bc *core.BlockChain, addrHashes, txHashes []common.Hash) {
	...
	blocks, _ := core.GenerateChain(gspec.Config, genesis, bfeash.NewFaker(), db, testChainLen,
	...
	bc, _ = core.NewBlockChain(db, nil, gspec.Config, bfeash.NewFaker(), vm.Config{}, nil, nil)
