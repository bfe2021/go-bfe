...
func (f *fuzzer) fuzz() int {
	...
	for i, pair := range []struct {
		...
		{bfeash.FrontierDifficultyCalulator, bfeash.CalcDifficultyFrontierU256},
		{bfeash.HomesteadDifficultyCalulator, bfeash.CalcDifficultyHomesteadU256},
		{bfeash.DynamicDifficultyCalculator(bombDelay), bfeash.MakeDifficultyCalculatorU256(bombDelay)},
	} {
