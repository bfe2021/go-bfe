Name "gbfe ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/bfe2021/go-bfe/issues"
!define UPDATEURL "https://github.com/bfe2021/go-bfe/releases"
!define ABOUTURL "https://github.com/bfe2021/go-bfe#bfedu-go"
...
# Install gbfe binary
Section "Gbfe" GBFE_IDX
  SetOutPath $INSTDIR
  file {{.Gbfe}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gbfe.exe"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gbfe.exe" "attach"
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe"

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Gbfe incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gbfe outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gbfe UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Gbfe incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\gbfe.exe" "" "" "Bfedu" 30303 "" "" ""
  SimpleFC::AdvAddRule "Gbfe outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\gbfe.exe" "" "" "Bfedu" "" 30303 "" ""
  SimpleFC::AdvAddRule "Gbfe UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\gbfe.exe" "" "" "Bfedu" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/bfe2021/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ORANGE_SOCKET" "R" "HKLM" "\\.\pipe\gbfe.ipc"
  ${EnvVarUpdate} $0 "ORANGE_SOCKET" "A" "HKLM" "\\.\pipe\gbfe.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${GBFE_IDX}
    SectionGetSize ${GBFE_IDX} $0
  ...
  IntFmt $GetInstalledSize.total "bfe%08X" $GetInstalledSize.total
