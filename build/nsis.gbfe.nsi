...
# 1. install gbfe for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gbfe
# 5. create gbfe, attach and uninstall start menu entries
...
!define GROUPNAME "Bfedu"
!define APPNAME "Gbfe"
!define DESCRIPTION "Official Go implementation of the Bfedu protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gbfe is installed global
