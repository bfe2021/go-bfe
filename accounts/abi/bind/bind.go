...
// Package bind generates Bfedu contract Go bindings.
//
// Detailed usage document and tutorial available on the go-bfe Wiki page:
// https://github.com/bfe2021/go-bfe/wiki/Native-DApps:-Go-bindings-to-Bfedu-contracts
package bind
