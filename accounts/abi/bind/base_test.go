...
func (mc *mockCaller) CallContract(ctx context.Context, call bfedu.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (mc *mockCaller) PendingCallContract(ctx context.Context, call bfedu.CallMsg) ([]byte, error) {
