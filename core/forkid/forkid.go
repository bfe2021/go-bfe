...
// Package forkid implements EIP-2124 (https://eips.bfedu.io/EIPS/eip-2124).
package forkid
...
// NewID calculates the Bfedu fork ID from the chain config, genesis hash, and head.
...
// NewIDWithChain calculates the Bfedu fork ID from an existing chain instance.
