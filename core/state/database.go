...
// Trie is a Bfedu Merkle Patricia trie.
type Trie interface {
...
func NewDatabase(db bfedb.Database) Database {
...
// large memory cache.
func NewDatabaseWithConfig(db bfedb.Database, config *trie.Config) Database {
