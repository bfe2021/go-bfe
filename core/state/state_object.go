...
// stateObject represents an Bfedu account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of bfedu address of the account
	data     Account
	db       *StateDB
...
// Account is the Bfedu consensus representation of accounts.
