...
// account array.
func checkStateAccounts(t *testing.T, db bfedb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db bfedb.Database, root common.Hash) error {
...
func checkStateConsistency(db bfedb.Database, root common.Hash) error {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(bfedb.Database), srcRoot)
