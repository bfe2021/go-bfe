...
func generateSnapshot(diskdb bfedb.KeyValueStore, triedb *trie.Database, cache int, root common.Hash, wiper chan struct{}) *diskLayer {
...
func journalProgress(db bfedb.KeyValueWriter, marker []byte, stats *generatorStats) {
