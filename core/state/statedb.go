...
// Package state provides a caching layer atop the Bfedu state trie.
package state
...
// StateDB structs within the bfedu protocol are used to store anything
...
//
// Carrying over the balance ensures that Bfeer doesn't disappear.
...
func (s *StateDB) Copy() *StateDB {
	...
	for addr := range s.journal.dirties {
		// As documented [here](https://github.com/bfe2021/go-bfe/pull/16485#issuecomment-380438527),
