...
func NewTable(db bfedb.Database, prefix string) bfedb.Database {
	return &table{
		db:     db,
		prefix: prefix,
	}
...
func (t *table) NewIterator(prefix []byte, start []byte) bfedb.Iterator {
...
func (t *table) NewBatch() bfedb.Batch {
...
func (b *tableBatch) Replay(w bfedb.KeyValueWriter) error {
