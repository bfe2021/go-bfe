...
// Package types contains data types related to Bfedu consensus.
package types
...
// Header represents a block header in the Bfedu blockchain.
type Header struct {
...
// Block represents an entire block in the Bfedu blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
	...
	// These fields are used by package  bfe  to track
...
// [deprecated by bfe/63]
// StorageBlock defines the RLP encoding of a Block stored in the
// state database. The StorageBlock encoding contains fields that
// would otherwise need to be recomputed.
type StorageBlock Block

// "external" block encoding. used for  bfe  protocol, etc.
...
// EncodeRLP serializes b into the Bfedu RLP block format.
