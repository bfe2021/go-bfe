...
import (
	...
	"github.com/bfe2021/go-bfe/p2p/simulations"
	"github.com/bfe2021/go-bfe/p2p/simulations/adapters"
...
func getHead(ctx context.Context, t *testing.T, client *rpc.Client) (uint64, common.Hash) {
	...
	if err := client.CallContext(ctx, &res, "bfe_getBlockByNumber", "latest", false); err != nil {
...
func testRequest(ctx context.Context, t *testing.T, client *rpc.Client) bool {
	...
	defer cancel()
	err := client.CallContext(c, &res, "bfe_getBalance", addr, "latest")
	if err != nil {
...
func newLesServerService(ctx *adapters.ServiceContext, stack *node.Node) (node.Lifecycle, error) {
	...
	bfedu, err := bfe.New(stack, &config)
	if err != nil {
		return nil, err
	}
	_, err = NewLesServer(stack, bfedu, &config)
	if err != nil {
		return nil, err
	}
	return bfedu, nil
