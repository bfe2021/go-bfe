...
// NodeInfo represents a short summary of the Bfedu sub-protocol metadata
...
func (c *lesCommons) setupOracle(node *node.Node, genesis common.Hash, bfeconfig *bfeconfig.Config) *checkpointoracle.CheckpointOracle {
	config := bfeconfig.CheckpointOracle
	if config == nil {
	...
	client := bfeclient.NewClient(rpcClient)
	oracle.Start(client)
