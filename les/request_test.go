...
type accessTestFn func(db bfedb.Database, bhash common.Hash, number uint64) light.OdrRequest
...
func tfBlockAccess(db bfedb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfReceiptsAccess(db bfedb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfTrieEntryAccess(db bfedb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfCodeAccess(db bfedb.Database, bhash common.Hash, num uint64) light.OdrRequest {
