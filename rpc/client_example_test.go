...
//
// bfe_getBlockByNumber("latest", {})
//    returns the latest block object.
//
// bfe_subscribe("newHeads")
...
func subscribeBlocks(client *rpc.Client, subch chan Block) {
	...
	sub, err := client.BfeSubscribe(ctx, subch, "newHeads")
	if err != nil {
	...
	var lastBlock Block
	err = client.CallContext(ctx, &lastBlock, "bfe_getBlockByNumber", "latest", false)
	if err != nil {
