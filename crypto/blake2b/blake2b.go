...
// key turns the hash into a MAC. The key must be between zero and 64 bytes lbfe.
...
// A non-nil key turns the hash into a MAC. The key must be between zero and 64 bytes lbfe.
