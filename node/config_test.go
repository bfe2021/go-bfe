...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gbfe.ipc", false, filepath.Join(os.TempDir(), "gbfe.ipc")},
		{"data", "gbfe.ipc", false, "data/gbfe.ipc"},
		{"data", "./gbfe.ipc", false, "./gbfe.ipc"},
		{"data", "/gbfe.ipc", false, "/gbfe.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gbfe.ipc", true, `\\.\pipe\gbfe.ipc`},
		{"data", "gbfe.ipc", true, `\\.\pipe\gbfe.ipc`},
		{"data", `\\.\pipe\gbfe.ipc`, true, `\\.\pipe\gbfe.ipc`},
	}
