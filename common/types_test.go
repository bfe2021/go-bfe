...
func TestAddressHexChecksum(t *testing.T) {
	var tests = []struct {
		...
		// Test cases from https://github.com/bfe2021/EIPs/blob/master/EIPS/eip-55.md#specification
...
func TestMixedcaseAccount_Address(t *testing.T) {
	...
	// https://github.com/bfe2021/EIPs/blob/master/EIPS/eip-55.md
	...
	for _, r := range []string{
		...
		`["0x11111111111111111111122222222222233333234"]`,  // Too logn
		`["0x111111111111111111111222222222222333332344"]`, // Too logn
