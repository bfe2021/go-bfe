...
type ExternalAPI interface {
	...
	SignTransaction(ctx context.Context, args SendTxArgs, MethodSelector *string) (*bfeapi.SignTransactionResult, error)
...
type UIClientAPI interface {
	...
	OnApprovedTx(tx bfeapi.SignTransactionResult)
...
func (api *SignerAPI) SignTransaction(ctx context.Context, args SendTxArgs, MethodSelector *string) (*bfeapi.SignTransactionResult, error) {
	var (
		err    error
	...
	response := bfeapi.SignTransactionResult{Raw: data, Tx: signedTx}
